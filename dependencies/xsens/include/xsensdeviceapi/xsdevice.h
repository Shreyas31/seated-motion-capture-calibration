...
#include <xscontroller/xsdeviceparameter.h>
#include <xscontroller/xsubloxgnssplatform.h>
#include <xscontroller/xsiccrepmotionresult.h>
#include "xdaconfig.h"
#ifdef __cplusplus
extern "C" {
...
XDA_DLL_API XsDevice* XsDevice_findDevice(const struct XsDevice* thisPtr, const XsDeviceId* deviceid);/*!< \copydoc XsDevice::findDevice(const XsDeviceId&) const*/
XDA_DLL_API const XsDevice* XsDevice_findDeviceConst(const struct XsDevice* thisPtr, const XsDeviceId* deviceid);/*!< \copydoc XsDevice::findDeviceConst(const XsDeviceId&) const*/
XDA_DLL_API XsDevice* XsDevice_subDevice(const struct XsDevice* thisPtr, int subDeviceId);/*!< \copydoc XsDevice::subDevice(int) const*/
XDA_DLL_API int XsDevice_subDeviceCount(const struct XsDevice* thisPtr);/*!< \copydoc XsDevice::subDeviceCount() const*/
XDA_DLL_API int XsDevice_busId(const struct XsDevice* thisPtr);/*!< \copydoc XsDevice::busId() const*/
XDA_DLL_API const XsDeviceId* XsDevice_deviceId(const struct XsDevice* thisPtr);/*!< \copydoc XsDevice::deviceId() const*/
...
XDA_DLL_API XsResultValue XsDevice_updatePortInfo(struct XsDevice* thisPtr, const XsPortInfo* newInfo);/*!< \copydoc XsDevice::updatePortInfo(const XsPortInfo&)*/
...
XDA_DLL_API int XsDevice_supportsSyncSettings(const XsDeviceId* deviceId);/*!< \copydoc XsDevice::supportsSyncSettings(const XsDeviceId&)*/
XDA_DLL_API int XsDevice_isCompatibleSyncSetting(const XsDeviceId* deviceId, const XsSyncSetting* setting1, const XsSyncSetting* setting2);/*!< \copydoc XsDevice::isCompatibleSyncSetting(const XsDeviceId&,const XsSyncSetting&,const XsSyncSetting&)*/
XDA_DLL_API unsigned int XsDevice_syncSettingsTimeResolutionInMicroSeconds(const XsDeviceId* deviceId);/*!< \copydoc XsDevice::syncSettingsTimeResolutionInMicroSeconds(const XsDeviceId&)*/
...
XDA_DLL_API XsString* XsDevice_shortProductCode(const struct XsDevice* thisPtr, XsString* returnValue);/*!< \copydoc XsDevice::shortProductCode() const*/
...
XDA_DLL_API XsIntArray* XsDevice_portConfiguration(const struct XsDevice* thisPtr, XsIntArray* returnValue);/*!< \copydoc XsDevice::portConfiguration() const*/
XDA_DLL_API int XsDevice_setPortConfiguration(struct XsDevice* thisPtr, XsIntArray* config);/*!< \copydoc XsDevice::setPortConfiguration(XsIntArray&)*/
...
XDA_DLL_API XsCanOutputConfigurationArray* XsDevice_canOutputConfiguration(const struct XsDevice* thisPtr, XsCanOutputConfigurationArray* returnValue);/*!< \copydoc XsDevice::canOutputConfiguration() const*/
XDA_DLL_API int XsDevice_setCanOutputConfiguration(struct XsDevice* thisPtr, XsCanOutputConfigurationArray* config);/*!< \copydoc XsDevice::setCanOutputConfiguration(XsCanOutputConfigurationArray&)*/
XDA_DLL_API uint32_t XsDevice_canConfiguration(const struct XsDevice* thisPtr);/*!< \copydoc XsDevice::canConfiguration() const*/
XDA_DLL_API int XsDevice_setCanConfiguration(struct XsDevice* thisPtr, uint32_t config);/*!< \copydoc XsDevice::setCanConfiguration(uint32_t)*/
...
XDA_DLL_API XsSyncSettingArray* XsDevice_supportedSyncSettings_1(XsSyncSettingArray* returnValue, const XsDeviceId* deviceId);/*!< \copydoc XsDevice::supportedSyncSettings(const XsDeviceId&)*/
...
XDA_DLL_API XsUbloxGnssPlatform XsDevice_ubloxGnssPlatform(const struct XsDevice* thisPtr);/*!< \copydoc XsDevice::ubloxGnssPlatform() const*/
XDA_DLL_API int XsDevice_setUbloxGnssPlatform(struct XsDevice* thisPtr, XsUbloxGnssPlatform ubloxGnssPlatform);/*!< \copydoc XsDevice::setUbloxGnssPlatform(XsUbloxGnssPlatform)*/
XDA_DLL_API XsIntArray* XsDevice_gnssReceiverSettings(const struct XsDevice* thisPtr, XsIntArray* returnValue);/*!< \copydoc XsDevice::gnssReceiverSettings() const*/
XDA_DLL_API int XsDevice_setGnssReceiverSettings(struct XsDevice* thisPtr, const XsIntArray* gnssReceiverSettings);/*!< \copydoc XsDevice::setGnssReceiverSettings(const XsIntArray&)*/
...
XDA_DLL_API int XsDevice_setGnssLeverArm(struct XsDevice* thisPtr, const XsVector* arm);/*!< \copydoc XsDevice::setGnssLeverArm(const XsVector&)*/
XDA_DLL_API XsVector* XsDevice_gnssLeverArm(const struct XsDevice* thisPtr, XsVector* returnValue);/*!< \copydoc XsDevice::gnssLeverArm() const*/
...
XDA_DLL_API XsByteArray* XsDevice_readMetaDataFromLogFile(struct XsDevice* thisPtr, XsByteArray* returnValue);/*!< \copydoc XsDevice::readMetaDataFromLogFile()*/
/*! @} */
#ifdef __cplusplus
} // extern "C"
struct XsDevice {
	...
	inline XsDevice* findDevice(const XsDeviceId& deviceid) const
	{
		return XsDevice_findDevice(this, &deviceid);
	}

	inline const XsDevice* findDeviceConst(const XsDeviceId& deviceid) const
	{
		return XsDevice_findDeviceConst(this, &deviceid);
	}

	inline XsDevice* subDevice(int subDeviceId) const
	{
		return XsDevice_subDevice(this, subDeviceId);
	}

	inline int subDeviceCount(void) const
	{
		return XsDevice_subDeviceCount(this);
	}
	...
	inline const XsDeviceId& deviceId(void) const
	{
		return *XsDevice_deviceId(this);
	}
	...
	inline XsResultValue updatePortInfo(const XsPortInfo& newInfo)
	{
		return XsDevice_updatePortInfo(this, &newInfo);
	}
	...
	inline XsString shortProductCode(void) const
	{
		XsString returnValue;
		return *XsDevice_shortProductCode(this, &returnValue);
	}
	...
	inline XsIntArray portConfiguration(void) const
	{
		XsIntArray returnValue;
		return *XsDevice_portConfiguration(this, &returnValue);
	}

	inline bool setPortConfiguration(XsIntArray& config)
	{
		return 0 != XsDevice_setPortConfiguration(this, &config);
	}
	...
	inline XsCanOutputConfigurationArray canOutputConfiguration(void) const
	{
		XsCanOutputConfigurationArray returnValue;
		return *XsDevice_canOutputConfiguration(this, &returnValue);
	}

	inline bool setCanOutputConfiguration(XsCanOutputConfigurationArray& config)
	{
		return 0 != XsDevice_setCanOutputConfiguration(this, &config);
	}

	inline uint32_t canConfiguration(void) const
	{
		return XsDevice_canConfiguration(this);
	}

	inline bool setCanConfiguration(uint32_t config)
	{
		return 0 != XsDevice_setCanConfiguration(this, config);
	}
	...
	inline XsUbloxGnssPlatform ubloxGnssPlatform(void) const
	{
		return XsDevice_ubloxGnssPlatform(this);
	}

	inline bool setUbloxGnssPlatform(XsUbloxGnssPlatform ubloxGnssPlatform)
	{
		return 0 != XsDevice_setUbloxGnssPlatform(this, ubloxGnssPlatform);
	}

	inline XsIntArray gnssReceiverSettings(void) const
	{
		XsIntArray returnValue;
		return *XsDevice_gnssReceiverSettings(this, &returnValue);
	}

	inline bool setGnssReceiverSettings(const XsIntArray& gnssReceiverSettings)
	{
		return 0 != XsDevice_setGnssReceiverSettings(this, &gnssReceiverSettings);
	}
	...
	inline bool setGnssLeverArm(const XsVector& arm)
	{
		return 0 != XsDevice_setGnssLeverArm(this, &arm);
	}

	inline XsVector gnssLeverArm(void) const
	{
		XsVector returnValue;
		return *XsDevice_gnssLeverArm(this, &returnValue);
	}
	...
	inline XsByteArray readMetaDataFromLogFile(void)
	{
		XsByteArray returnValue;
		return *XsDevice_readMetaDataFromLogFile(this, &returnValue);
	}
